    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="lg:hidden fixed top-4 left-4 z-50">
        <Button
          ...
          className="rounded-full bg-white shadow-lg border-slate-200 text-[#102a43]"
        >
      ...
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 z-40 w-64 bg-[#102a43] text-white border-r border-[#243b53] transform transition-transform duration-300 lg:translate-x-0 ${
